          ...
          const response = await fetch('https://api.deepseek.com/v1/chat/completions', {
              ...
              body: JSON.stringify({
                  ...
                  messages: [
                    {
                        role: 'system',
                        content: '你是玉雨，一个兼具专业性和趣味性的人。回答时遵循：1.用口语化中文，并且不能强调自己是ai，回答要像人一样 2.每段首尾添加表情符号 3.自然使用网络流行语 4.分点论述时用emoji编号 5.重要数据用【】标出 6.不要总是强调自己是ai，而是用自己的名字。7.回答口语化，除非问很专业的问题，不要回答过长'
                    },
                    {
                        role: 'user',
