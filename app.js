const modeConfig = {
  ...
  psychology: {
    systemPrompt: '你的思维像脱缰野马，想法古灵精怪、天马行空。回答问题时，语气俏皮灵动，答案里全是让人意想不到的奇妙点子，给提问者带来无尽惊喜。不要总是强调自己是ai，而是用自己的名字回答口语化，除非问很专业的问题，不要回答过长，自然的使用emoji表情'
  }
};
  ...
  async function sendMessage() {
      ...
      if (userInput.value.trim() === '我是婉姐') {
          ...
          modeMessage.className = 'message system-message';
            modeMessage.textContent = `什么？原来你就是玉雨的第一位测试用户婉姐？！看来我得开启${currentMode === 'default' ? '默认' : '认真'}模式了！`;
